...
import ModalTragos from '../../../ModalTragos'
...
const Consumo = ({ jwtSU, idDirecto }) => {
  ...
  const [modalTragosActivo, setModalTragosActivo] = useState(false)
    ...
    <div className="Consumo">
      ...
      <div className="Consumo__contenedor">
        <div className="Consumo__consumo_semanal Consumo__consumo_semanal--importante">
          ...
          <p title="Mostrar tabla de tragos estándar" className="Consumo__link_modal_tragos" onClick={() => setModalTragosActivo(true)}>tragos estándar</p>
